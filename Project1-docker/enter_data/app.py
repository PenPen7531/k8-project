...
db_conn = mysql.connector.connect(host="mysql_db", user="root", password="P@ssw0rd", database="users")
...
def home():
    ...
    if request.method=="POST":
        ...
        if username.upper() == 'ADMIN':
            reponse = requests.get(f"http://auth_service:3000/api/users/{username.upper()}")
